...
class MTL_Tools:
    ...
    def initGui(self):
        ...
        icon = QIcon(os.path.join(os.path.dirname(__file__), "icons", "agriculture.ico"))
        self.agriculture_menu.setIcon(icon)
        self.layers_menu = QMenu("Camadas", self.menu)
        icon = QIcon(os.path.join(os.path.dirname(__file__), "icons", "layer.ico"))
        self.layers_menu.setIcon(icon)
        self.layouts_menu = QMenu("Layouts", self.menu)
        icon = QIcon(os.path.join(os.path.dirname(__file__), "icons", "layout.ico"))
        self.layouts_menu.setIcon(icon)
        self.raster_menu = QMenu("Raster", self.menu)
        icon = QIcon(os.path.join(os.path.dirname(__file__), "icons", "raster.ico"))
        self.raster_menu.setIcon(icon)
        self.system_menu = QMenu("Sistema", self.menu)
        icon = QIcon(os.path.join(os.path.dirname(__file__), "icons", "system.ico"))
        self.system_menu.setIcon(icon)
        self.vectors_menu = QMenu("Vetores", self.menu)
        icon = QIcon(os.path.join(os.path.dirname(__file__), "icons", "vector.ico"))
        ...
        export_icon = os.path.join(os.path.dirname(__file__), "icons", "export_icon.ico")
        ...
        replace_icon = os.path.join(os.path.dirname(__file__), "icons", "replace_in_layouts.ico")
        ...
        # 3-Restart QGIS
        restart_icon = os.path.join(os.path.dirname(__file__), "icons", "restart_qgis.ico")
        ...
        load_icon = os.path.join(os.path.dirname(__file__), "icons", "load_folder.ico")
        ...
        gerar_icon = os.path.join(os.path.dirname(__file__), "icons", "gerar_rastro.ico")
        ...
        # 6-About Dialog
        about_icon = os.path.join(os.path.dirname(__file__), "icons", "about.ico")
        ...
        # null-base tool
        base_tool_icon = os.path.join(os.path.dirname(__file__), "icons", "mtl_agro.ico")
        ...
        coord_icon = os.path.join(os.path.dirname(__file__), "icons", "coord.ico")
        ...
        vector_field_icon = os.path.join(os.path.dirname(__file__), "icons", "vector_field.ico")
        ...
        drone_coord_icon = os.path.join(os.path.dirname(__file__), "icons", "drone_cordinates.ico")
        ...
        multipart_icon = os.path.join(os.path.dirname(__file__), "icons", "vector_multpart.ico")
        ...
        copy_atributes_icon = os.path.join(os.path.dirname(__file__), "icons", "copy_attributes.ico")
