# -*- coding: utf-8 -*-
"""
Widget universal para seleção de pastas, múltiplas pastas, arquivos, múltiplos arquivos e salvamento.

Arquitetura ENCAPSULADA:
- Suporta múltiplos modos: folder, folders, file, files, save
...
Uso:
    widget = SelectorWidget(mode="save", checkbox=True)
