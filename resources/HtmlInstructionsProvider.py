...
class HtmlInstructionsProvider:
    ...
    def __init__(self, tool_key: str):  
        self.logger = LogUtils(tool=tool_key, class_name="HtmlInstructionsProvider", level="DEBUG")   
        ...
        self.logo = f'{self._get_image("cadmus_icon.png")}'    
        
        
    def _get_image(self, image_name: str,width: int = 100) -> str:
        path = os.path.join(
            os.path.dirname(__file__), "..", "icons", image_name  )        
